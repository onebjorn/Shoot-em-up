...
public:
  ...
  float const & x1() override { return m_bullet.x1(); }
  float const & y1() override { return m_bullet.y1(); }
  float const & x2() override { return m_bullet.x2(); }
  float const & y2() override { return m_bullet.y2(); }
